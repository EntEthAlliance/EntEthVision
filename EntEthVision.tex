...
\fancyhead[L]{}
\fancyhead[R]{
\vspace*{-2cm}\hspace*{15cm}\includegraphics[width=4cm]{figures/enterprise-ethereum-alliance.png}
}
...
\pagestyle{plain}
\title[Enterprise Ethereum Alliance Vision]{{Enterprise Ethereum Alliance - Vision}}
% \hspace*{-4.9cm}
% {\scriptsize (v3.0)}
% 
\author{{\scriptsize 28 February, 2017}}
